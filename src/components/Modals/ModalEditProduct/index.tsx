...
const ModalEditProduct: React.FC<{
...
}> = ({ isVisible, onClose, product, refreshProducts }) => {
  ...
  const onSubmitNewProduct: SubmitHandler<any> = async (data, { reset }) => {
    try {
      ...
      toast(`Produto modificado com sucesso!`, {
        type: `success`,
      });
      reset();
      onClose();
      ...
      console.log(error);
      toast(`Não foi possível modificar o produto, tente novamente.`, {
        type: `error`,
      });
    }
  };
  ...
  const onDeleteProduct = async () => {
    try {
      ...
      console.log(error);
      toast(`Não foi possível deletar o produto, tente novamente.`, {
        type: `error`,
      });
    }
  };
  ...
  return (
    ...
    >
      ...
      <ContainerForm onSubmit={onSubmitNewProduct}>
        <ContainerImageListIngredients>
          <ContainerColumn>
            <TitleModal>Editar produto</TitleModal>
